...
import com.example.yuchat.activity.YUDressUp;
import com.example.yuchat.activity.YUProfile;
import com.example.yuchat.activity.YUSetting;
    ...
    private void initViews() {
        ...
        dressUp.setOnClickListener(new PicAndTextBtn.picAndTextBtnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context,YUDressUp.class);
        ...
        profile.setOnClickListener(new PicAndTextBtn.picAndTextBtnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context,YUProfile.class);
                context.startActivity(intent);
            }
        });
        ...
        setting.setOnClickListener(new PicAndTextBtn.picAndTextBtnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context,YUSetting.class);
                context.startActivity(intent);
            }
        });
